...
public function onBreak(BlockBreakEvent $ev){
		...
		$player->addTitle("§c".$this->bluehp, "§bBLUETEAM§fのコアが破壊されています" , 20, 20, 20);

		}else{

		$player->addTitle("§a".$this->bluehp, "§bBLUETEAM§fのコアが破壊されています" , 20, 20, 20);
		...
		$player->addTitle("§c".$this->redhp, "§cREDTEAM§fのコアが破壊されています" , 20, 20, 20);

		}else{

		$player->addTitle("§a".$this->redhp, "§cREDTEAM§fのコアが破壊されています" , 20, 20, 20);
